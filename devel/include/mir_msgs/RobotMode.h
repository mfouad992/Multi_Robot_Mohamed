...
#endif
#if defined(_WIN32) && defined(ROBOT_MODE_NOMAP)
  #undef ROBOT_MODE_NOMAP
#endif
#if defined(_WIN32) && defined(ROBOT_MODE_MANUEL)
  #undef ROBOT_MODE_MANUEL
#endif
#if defined(_WIN32) && defined(ROBOT_MODE_MAPPING)
  #undef ROBOT_MODE_MAPPING
#endif
#if defined(_WIN32) && defined(ROBOT_MODE_TAXA)
  #undef ROBOT_MODE_TAXA
#endif
#if defined(_WIN32) && defined(ROBOT_MODE_BUS)
  #undef ROBOT_MODE_BUS
#endif
#if defined(_WIN32) && defined(ROBOT_MODE_POST)
  #undef ROBOT_MODE_POST
#endif
...
struct MD5Sum< ::mir_msgs::RobotMode_<ContainerAllocator> >
{
  ...
  {
    return "0b618a0128c4f65d17a9f29cebd6333e";
  }

  static const char* value(const ::mir_msgs::RobotMode_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x0b618a0128c4f65dULL;
  static const uint64_t static_value2 = 0x17a9f29cebd6333eULL;
};
...
"uint8 ROBOT_MODE_NOMAP = 1		# basic mode operating with no map given\n"
"uint8 ROBOT_MODE_MANUEL = 2		# \n"
"uint8 ROBOT_MODE_MAPPING = 3		# in mapping a new map is made\n"
"uint8 ROBOT_MODE_TAXA = 4		# basic motion to a new position\n"
"uint8 ROBOT_MODE_BUS = 5		# bus mode, following a bus-plan\n"
"uint8 ROBOT_MODE_POST = 6		# post devilery mode, some how restricted\n"
